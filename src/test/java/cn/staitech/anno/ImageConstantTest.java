...
import cn.staitech.common.core.web.page.PageDomain;
import cn.staitech.common.core.web.page.TableSupport;
...
public class ImageConstantTest {
    ...
    public void put(){
        for (int i = 0; i < 3;i++) {
            System.out.println(i + ":" + ImageConstant.IMAGE_PROCESS_MAP.get(i));
        }

//      ImageConstant.IMAGE_PROCESS_MAP.put(1,"aaa");
