...
import cn.staitech.anno.domain.vo.specialImageAnno.in.AlgorithmGeometry;
import cn.staitech.anno.domain.vo.specialImageAnno.in.CallBackAnnAddIn;
import cn.staitech.anno.domain.vo.specialImageAnno.in.CallBackAnnGeometry;
...
import cn.staitech.anno.mapper.AlgorithmSpecialImageMapper;
...
import cn.staitech.anno.utils.MarkVerify;
...
public class SpecialImageAnnoServiceImpl implements SpecialImageAnnoService {
	...
	@Resource
	private AlgorithmSpecialImageMapper algorithmSpecialImageMapper;
	@Resource
	...
	public R<String> updateDeliveryBySpecialId(AuditSpecialImageVO vo) {
		...
		if(CollectionUtils.isEmpty(list)){
			...
			return R.fail(SpecialImageConstant.OPERATE_ERROR);
		}
		return R.ok(OPERATE_SUCCEED);
	}
	...
	public R<String> updateAnnotation(SpecialAnnotation anno) {
		...
		//		return R.ok(anno.getLocation(), ResponseConstant.OPERATE_SUCCEED);
	...
	public R<List<SpecialAnnoAddVO>> annotationSave(List<SpecialAnnoAddVO> annoList,SpecialImage sImage) throws Exception {
		...
		return  R.ok(retList,OPERATE_SUCCEED);
	}
