package cn.staitech.anno.vo.diagnosis;
...
@AllArgsConstructor
@NoArgsConstructor
public class SpecialDiagnosisDetail {
    ...
    @ApiModelProperty(name = "tagName", value = "标签列表名称")
    private String tagName;

    @ApiModelProperty(name = "customizeTagName", value = "自定义标签名称")
    private String customizeTagName;
