...
@Builder
@Data
public class MeasureEnVo {

    @ExcelProperty(value = "User",  index = 9)
    private String createUserName;

    @JsonProperty(value = "point_count")
    @ExcelProperty(value = "Points(Num)",  index = 8)
     ...
     * 面积
     */
    @ExcelProperty(value = "Area(um²)",  index = 2)
    private String area;

    /**
     * 周长
     */
    @ExcelProperty(value = "Length/Perimeter (um)",  index = 1)
    ...
    @ExcelProperty(value = "Average Distance (um)",  index = 5)
 ...
 //   @ExcelProperty(value = "最大间距",  index = 7)
    ...
    @ExcelProperty(value = "Minimum Distance (um)",  index = 6)
    ...
    @ExcelProperty(value = "Interior angle (°)",  index = 3)
    ...
    @ExcelProperty(value = "Exterior angle (°)",  index = 4)
    ...
    @ExcelProperty(value = "Operation Time",  index = 10)
    ...
    public static MeasureEnVo convert(Measure measure){
        MeasureEnVo measureVo = new MeasureEnVo();
        try {
