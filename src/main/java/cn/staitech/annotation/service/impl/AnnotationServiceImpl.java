...
import cn.staitech.annotation.domain.AnnotationDel;
import cn.staitech.annotation.mapper.AnnotationDelMapper;
...
import cn.staitech.annotation.mapper.AnnotationMapper;
            ...
            for (UndoRedoDetail undoRedoDetail : undoRedoDetails) {
                try {
                    if (undoRedoDetail.getOperation().equals(Constant.ANNO_ACTION_DELETE)) {
                        ...
                        annotationDelMapper.deleteById(saveVo.getAnnotationId());
